  ...
  case GPSALT :
    {
      ...
      frskyBuffer[bufferLength + 5] = header_value;
      frskyBuffer[bufferLength + 6] = GPSALT + decimal;
      frskyBuffer[bufferLength + 7] = lsByte(temp);
      frskyBuffer[bufferLength + 8] = msByte(temp);
      frskyBuffer[bufferLength + 9] = header_value;
      return 10;
  ...
  case ALTITUDE :
    {
      ...
      frskyBuffer[bufferLength + 5] = header_value;
      frskyBuffer[bufferLength + 6] = ALTIDEC;
      frskyBuffer[bufferLength + 7] = lsByte(temp);
      frskyBuffer[bufferLength + 8] = msByte(temp);
      frskyBuffer[bufferLength + 9] = header_value;
  ...
  case GPSSPEED :
    {
      ...
      frskyBuffer[bufferLength + 5] = header_value;
      frskyBuffer[bufferLength + 6] = GPSSPEED + decimal;
      frskyBuffer[bufferLength + 7] = lsByte(temp);
      frskyBuffer[bufferLength + 8] = msByte(temp);
      frskyBuffer[bufferLength + 9] = header_value;
  ...
  case LATITUDE :
    {
      ...
      frskyBuffer[bufferLength + 12] = header_value;
  ...
  case COURSE :
    {
      ...
      frskyBuffer[bufferLength + 5] = header_value;
      frskyBuffer[bufferLength + 6] = COURSE + decimal;
      frskyBuffer[bufferLength + 7] = lsByte(temp);
      frskyBuffer[bufferLength + 8] = msByte(temp);
      frskyBuffer[bufferLength + 9] = header_value;
  ...
  case VOLTAGE :
    {
      ...
      frskyBuffer[bufferLength + 5] = header_value;
      frskyBuffer[bufferLength + 6] = VOLTAGEDEC;
      frskyBuffer[bufferLength + 7] = lsByte(temp);
      frskyBuffer[bufferLength + 8] = msByte(temp);
      frskyBuffer[bufferLength + 9] = header_value;
